...
\section{Capitulo 1. Especificación}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ins-catorce}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ins-cuarentanueve}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ins-diecisiete}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{ins-uno}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{ins-dos-pre}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{ins-dos-pre-dos}
\caption{Division de la celda atemporal de $k+1 = 4$ posiciones}
\label{drivers1}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{ins-dos-pre-tres}
\caption{Insercion de la clave 2 en la celda atemporal de $k+1 = 4$ posiciones}
\label{drivers1}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{ins-dos-pre-cuatro}
\caption{Division de la celda atemporal de $k+1 = 4$ posiciones}
\label{drivers1}
\end{figure}
\newpage
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{ins-dos}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{elim-orig}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{elim-veintinueve}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{elim-nueve}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{elim-dieciocho}
\caption{Borrado de la clave 18}
\label{drivers1}
\end{figure}
\newpage

\subsubsection{Caso 2. Borrado de una clave $k$ ubicada en un nodo interno}

En este caso, queremos eliminar al nodo 62. Como es un nodo interno, debemos buscar el predecesor o sucesor inmediato. Si elegimos al sucesor inmediato (clave numero 63), se elimina a la clave 63 de su nodo y dicho nodo se convierte en invalido. Como el hermano derecho no puede prestarle y no tiene hermano izquierdo, se une con su padre al nodo de su hermano derecho.

\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{elim-sesentados-pre}
\caption{Borrado de la clave 62}
\label{drivers1}
\end{figure}

Pero observemos ahora que el nodo que contiene a la clave 45 es invalido. Entonces, le pregunta al hermano si puede prestarle. Como el hermano izquierdo no puede prestarle, le pregunta al hermano derecho y como no tiene hermano derecho, le solicita ayuda al padre.
\newline
\newline
Por lo tanto, se fusionan o unen en el nodo hermano izquierdo (contiene al 20 y 23) el 39 y el 45 de manera que quede ordenado el nodo.

\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{elim-sesentados}
\caption{Borrado de la clave 62}
\label{drivers1}
\end{figure}
